...
We have chosen the Bubble Chart to help the user to compare the difference in the number of people between the different countries. Moreover, with the colour scale we also help the user to understand either which country send more tourists abroad, or which country receives more visitors.
